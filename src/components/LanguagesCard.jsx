...
const LanguagesCard = () => {
  return (
    <div className=" mx-7 rounded-lg rotate-[-1deg] border border-slate-100 dark:border-slate-800 dark:bg-gradient-to-br from-slate-800 to-slate-900 flex-wrap overflow-auto p-1.5">
