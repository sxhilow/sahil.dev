...
export default function Home(){
  return(
    <section className="bg-base-200 dark:bg-base-100 text-slate-900 dark:text-slate-200 w-full pb-[15%] md:pb-0 md:ml-[10%] min-h-full md:w-[90%] md:h-full md:flex mx-auto pt-3">
