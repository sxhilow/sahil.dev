...
export default function Home(){
  return(
    <section className="bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-200 w-full pb-[15%] md:pb-0 md:ml-[10%] min-h-full md:w-[90%] md:h-full md:flex m-auto">
